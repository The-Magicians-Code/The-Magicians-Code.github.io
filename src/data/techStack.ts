// Data for the website's visual tech-stack section. Each item maps a display
// name to a logo slug (raw SVGs in src/assets/logos/, generated by
// scripts/gen-tech-logos.mjs from theSVG). SQL/REST have no brand mark, so they
// use the SQLite/OpenAPI marks. `featured` items get an accent ring — the tools
// previously emphasised with <em> in the old chip layout.
//
// NOTE: the resume PDF has its OWN, intentionally separate skill list in
